/****************************************************************************
** $Id: qobjectdefs.h,v 1.1 2003/11/04 10:14:21 Sigma Exp $
**
...
#if defined(Q_CC_MIPS) && defined(_MIPS_SIM) && (_MIPS_SIM == _ABIO32)
#define QT_CAST(type, object) ::qt_cast(object, (type)0)
template <class T>
Q_INLINE_TEMPLATES T qt_cast(const QObject *object, T)
{ return (T)qt_inheritedBy( ((T)0)->staticMetaObject(), object ); }
#elif defined(Q_CC_SUN) && (__SUNPRO_CC <= 0x500)
#define QT_CAST(type, object) ::qt_cast(object, (type)0)
template <typename T>
Q_INLINE_TEMPLATES T qt_cast(const QObject *object, T)
{ return (T)qt_inheritedBy( ((T)0)->staticMetaObject(), object ); }
