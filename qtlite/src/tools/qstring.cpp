/****************************************************************************
** $Id: qstring.cpp,v 1.1 2003/11/04 10:14:20 Sigma Exp $
**
...
#if defined( Q_OS_MAC ) || defined(Q_OS_SOLARIS)
